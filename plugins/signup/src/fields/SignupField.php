...
namespace wolff\signup\fields;

use wolff\signup\Signup;
use wolff\signup\assetbundles\signupfieldfield\SignupFieldFieldAsset;
 ...
 * @since     1.0.0
 */
class SignupField extends Field
{
    // Public Properties
    // =========================================================================
    ...
    {
        return Craft::t('signup', 'SignupField');
    }
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'signup/_components/fields/SignupField_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerAssetBundle(SignupFieldFieldAsset::class);
        ...
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').SignupSignupField(" . $jsonVars . ");");

        // Render the input template
        return Craft::$app->getView()->renderTemplate(
            'signup/_components/fields/SignupField_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,
